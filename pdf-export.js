...
// Função para inicializar o botão de exportação de PDF
// Esta função será chamada por script.js após sua inicialização completa.
...
// Exportar a função principal e a função de inicialização do botão
window.PDFExport = { exportToPDF: exportToPDF, initPdfExportButton: initPdfExportButton };